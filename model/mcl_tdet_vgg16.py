...
class MCL_TDET_VGG16(nn.Module):
    def __init__(self, pretrained_model_path=None, num_class=20, pooling_method='roi_pooling', share_level=2, mil_topk=1, num_group=1, use_predefined_group=False, share_negative=False):
    ...
    def forward_det_only(self, im_data, rois, gt_labels=None, predefined_groups=None):
        ...
        all_loss = F.binary_cross_entropy_with_logits(det_score, gt_labels.to(torch.float32))
